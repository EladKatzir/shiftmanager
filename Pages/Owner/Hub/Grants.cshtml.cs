...
/// </summary>
// SECURITY-AUDITED: All IgnoreQueryFilters() in this class are SAFE — Owner grant management requires Grant:AdminAccess (all ~136 grants; exact count: _db.GrantTypes.CountAsync(gt => gt.IsActive))
