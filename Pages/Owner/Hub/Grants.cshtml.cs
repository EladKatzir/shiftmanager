...
/// </summary>
// SECURITY-AUDITED: All IgnoreQueryFilters() in this class are SAFE — Owner grant management requires Grant:AdminAccess (all ~135 grants; exact count: _db.GrantTypes.CountAsync(gt => gt.IsActive))
