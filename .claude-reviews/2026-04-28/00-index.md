...
- Last updated: 2026-05-06 (post-batch execution)
...
| **K — Hot-path perf sweep** | ⏸️ Deferred | 1,720 LoggerMessage sites + 158 `.Any()` + 29 `JsonOptions`. Multi-PR effort by file group; correctly characterized as Large. |
| **L — Hebrew/culture sweep** | ⏸️ Deferred | 596 sites across MailService/NotificationService/ProfileService. Multi-PR by service. |
...
| **S — Auth edge cases** | ⏸️ Deferred | F-H-011/014/015. Each needs careful per-site analysis. |
| **T — Drop-in PRs** | ⏸️ Deferred | Long tail. |
