...
const TEST_USERS = {
  ...
  'dir.alhut@test': { role: 'Director', company: 'Tzafona', jobType: 'Alhut', template: 'AlhutDirector' },
  'dir.text@test': { role: 'Director', company: 'Hitazmut', jobType: 'Text', template: 'TextDirector' },
  ...
  'mgr.alhut.tz@test': { role: 'Manager', company: 'Tzafona', jobType: 'Alhut', template: 'AlhutLead' },
  'mgr.text.tz@test': { role: 'Manager', company: 'Tzafona', jobType: 'Text', template: 'TextLead' },
